...
function cari($keyword)
{
    ...
    return query($query);
    $query = "SELECT * FROM tbl_user WHERE username LIKE '%$keyword%'";
    return query($query);
    $query = "SELECT * FROM tbl_kategori WHERE nama_kategori LIKE '%$keyword%'";
    return query($query);
}
...
function tambahkategori($data)
{
    ...
    $query = "INSERT INTO tbl_kategori VALUES ('', '$nama_kategori', '$gambar')";
    mysqli_query($conn, $query);
...
function ubahkategori($data)
{
    ...
    $query = "UPDATE tbl_kategori SET nama_kategori = '$nama_kategori', gambar = '$gambar' WHERE id_kategori = '$id' ";
    mysqli_query($conn, $query);
