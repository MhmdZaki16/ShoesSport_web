...
if (isset($_POST["submit"])) {
    ...
    if (tambahkategori($_POST) > 0) {
        echo "<script>alert('Berhasil Menambahkan Kategori'); document.location.href = 'kategori.php'; </script>";
    } else {
        echo "<script>alert('Gagal Menambahkan Kategori'); document.location.href = 'kategori.php'; </script>";
    }
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <ul>
                        <li>
                            ...
                            <input type="text" name="nama_kategori" id="nama_kategori" required autocomplete="off">
                        </li>
