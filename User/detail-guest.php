            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-4">
                        ...
                        <a class="btn btn-primary px-3" href="daftar.php"><i class="fa fa-shopping-cart mr-1" ></i> Add To
                            Cart</a>
                        <a class="btn btn-primary px-3 mx-3" href="daftar.php" style="color: black;"> Beli</a>
                    </div>
