    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="img/Produk1.jfif" alt="" style="width: 50px;">Nike Air
                                Zoom</td>
                            <td class="align-middle">Rp 1.750.000 </td>
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/Produk2.jfif" alt="" style="width: 50px;">Nike
                                Alphafly</td>
                            <td class="align-middle">Rp 900.000</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button class="btn btn-sm btn-primary btn-minus">
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/Produk3.jfif" alt="" style="width: 50px;"> Adidas
                                Ultraboost</td>
                            <td class="align-middle">Rp 780.000</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button class="btn btn-sm btn-primary btn-minus">
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/Produk4.jfif" alt="" style="width: 50px;"> Nike Zoom
                                GT</td>
                            <td class="align-middle">Rp 990.000</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button class="btn btn-sm btn-primary btn-minus">
                        ...
                        <tr>
                            <td class="align-middle"><img src="img/Produk5.jfif" alt="" style="width: 50px;"> Converse
                                Chuck</td>
                            <td class="align-middle">Rp 795.000</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                                        <button class="btn btn-sm btn-primary btn-minus">
            ...
            <div class="col-lg-4">
                ...
                <h5 class="section-title position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Bayar</span></h5>
                <div class="bg-light p-30 mb-5">
                    ...
                    <div class="pt-2">
                        ...
                        <a class="btn btn-block btn-primary font-weight-bold my-3 py-3" href="checkout.php">Pembayaran</a>
                    </div>
                </div>
            </div>
        </div>
